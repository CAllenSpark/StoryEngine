...
Versioned, markdown-native knowledge base. Updated at the end of every sprint.

## Pages
- [Architecture](architecture.md) — system map and component boundaries.
- [Coding Standards](coding-standards.md) — <200 LOC, hooks, review rules.
